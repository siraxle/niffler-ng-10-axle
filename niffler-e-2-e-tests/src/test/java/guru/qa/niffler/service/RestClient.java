...
public abstract class RestClient {
    ...
    @SafeVarargs
    public RestClient(String baseUrl, Converter.Factory converteFactory, boolean followRedirect, @Nullable Interceptor... interceptors) {
        ...
        this.retrofit = new Retrofit.Builder()
                .baseUrl(baseUrl)
                .addConverterFactory(converteFactory)
                .client(okHttpClient)
                .build();
    }
