...
import guru.qa.niffler.service.GhAPIClient_;
...
public class IssueExtension_ implements ExecutionCondition {
    private final GhAPIClient_ ghApiClient = new GhAPIClient_();
